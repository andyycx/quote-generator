quotes = [
    ...
    ["When it comes to sex there are certain things that should always be left unknown, and with my luck, they probably will be.", "Everything You Always Wanted to Know About Sex*"],
    ...
    ["Interestingly, according to modern astronomers, space is finite. This is a very comforting thought - particularly for people who can never remember where they have left things", "Side Effects"],
    ["I thought of that old joke: This guy goes to a psychiatrist and says, 'Doc, my brother's crazy, he thinks he's a chicken.' And the doctor says, 'Well why don't you turn him in?' and the guy says, 'I would, but I need the eggs.' Well, I guess that's pretty much now how I feel about relationships. They're totally irrational and crazy and absurd, but I guess we keep going through it because most of us need the eggs.", "Annie Hall"],
    ["It's just gossip, you know. Gossip is the new pornography.", "Manhattan"],
    ["Talent is luck. The important thing in life is courage.", "Manhattan"],
    ...
    ["The talent for being happy is appreciating and liking what you have, instead of what you don't have.", "Woody Allen on Woody Allen"],
    ["I like the rain. It washes memories off the sidewalk of life.", "Manhattan"],
    ["Yeah, that's what the present is. It's a little unsatisfying because life's a little unsatisfying", "Midnight in Paris"],
    ["To be loved, certainly, is different from being admired, as one can be admired from afar but to really love someone it is essential to be in the same room with the person, crouching behind the drapes.", "Without Feathers"],
    ["优秀是一种习惯", "Dying"]
]
